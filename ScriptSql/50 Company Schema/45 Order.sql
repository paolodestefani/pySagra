...
CREATE TABLE numbering (
    ...
    --
    numbering_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE order_header (
    ...
    company_id              integer NOT NULL,
    --
    order_header_id         BIGINT GENERATED BY DEFAULT AS IDENTITY,
    event_id                BIGINT NOT NULL,
    order_date_time         timestamptz(3) NOT NULL DEFAULT now(),
...
CREATE TABLE order_header_department (
    ...
    company_id                  integer NOT NULL,
    --
    order_header_department_id  BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE order_line_department (
    ...
    company_id                  integer NOT NULL,
    --
    order_line_department_id    BIGINT GENERATED BY DEFAULT AS IDENTITY,
    order_header_department_id  BIGINT NOT NULL,
    event_id                    BIGINT NOT NULL,   -- for inventory trigger 
