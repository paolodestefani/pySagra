...
CREATE TABLE item (
    ...
    is_salable              boolean NOT NULL DEFAULT false,
	is_web_available        boolean NOT NULL DEFAULT false,
...
CREATE TABLE item_variant (
    ...
    company_id              integer NOT NULL,
    --
    item_variant_id         BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE item_part (
    ...
    company_id          integer NOT NULL,
    --
    item_part_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
