...
CREATE TABLE adaptation (
    ...
    --
    adaptation_id           BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1001 INCREMENT BY 1),
    ...
    CONSTRAINT adaptation_type_check
        CHECK (type IN ('I', 'S', 'R')),
...
CREATE TABLE adaptation_setting (
    ...
    object_version          integer NOT NULL,
    --
    adaptation_setting_id   BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 100001 INCREMENT BY 1),
    ...
    CONSTRAINT adaptation_setting_element_type_check
        CHECK (element_type IN ('P', 'F', 'S')),
)
TABLESPACE {pyAppPgTablesTS};
...
CREATE TABLE system.adaptation_user_default (
    ...
    CONSTRAINT adaptation_user_default_pk 
        ...
        USING INDEX TABLESPACE {pyAppPgIndexesTS},
    CONSTRAINT adaptation_user_default_type_check
        CHECK (type IN ('I', 'S', 'R')),
