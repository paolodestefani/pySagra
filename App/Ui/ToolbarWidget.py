...
class Ui_ToolbarWidget(object):
    def setupUi(self, ToolbarWidget):
        if not ToolbarWidget.objectName():
            ToolbarWidget.setObjectName(u"ToolbarWidget")
        ToolbarWidget.resize(774, 504)
        self.verticalLayout_7 = QVBoxLayout(ToolbarWidget)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.verticalLayout_7.setContentsMargins(5, 5, 5, 5)
        self.stackedWidget = QStackedWidget(ToolbarWidget)
    ...
    def retranslateUi(self, ToolbarWidget):
        ToolbarWidget.setWindowTitle(QCoreApplication.translate("ToolbarWidget", u"Toolbar", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("ToolbarWidget", u"Code", None))
        self.checkBoxSystem.setText(QCoreApplication.translate("ToolbarWidget", u"System toolbar", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("ToolbarWidget", u"Description", None))
